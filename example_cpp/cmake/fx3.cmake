...
set(FX3_LINKER_SCRIPT "fx3cpp.ld")

# -Map $(MODULE).map
set(CMAKE_EXE_LINKER_FLAGS
        "-T \"${CMAKE_SOURCE_DIR}/make/${FX3_LINKER_SCRIPT}\" -d --gc-sections --no-wchar-size-warning -nostdlib -nostartfiles --entry CyU3PFirmwareEntry")
...
function(fx3_add_target target)
  ...
  if (FX3_USE_STDC_LIB)
      # Link the C++ runtime libraries first so that libstdc++.a can resolve its own C symbol dependencies
      if (FX3_USE_STDCXX_LIB)
          # FX3_CXX_LIBS typically contains libstdc++.a
          target_link_libraries(${target} ${FX3_CXX_LIBS})
      endif()

      # Then link the C standard libraries and libgcc to resolve any remaining C-level symbols
      # FX3_C_LIBS includes libc.a, libm.a, libgcc.a, etc.
